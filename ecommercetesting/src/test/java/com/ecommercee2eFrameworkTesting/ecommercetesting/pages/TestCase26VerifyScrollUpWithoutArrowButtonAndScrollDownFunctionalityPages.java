...
public class TestCase26VerifyScrollUpWithoutArrowButtonAndScrollDownFunctionalityPages extends BasePage {
    public TestCase26VerifyScrollUpWithoutArrowButtonAndScrollDownFunctionalityPages(WebDriver driver) {
        super(driver);
    }
